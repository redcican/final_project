...
urlpatterns = [
    path('ml', views.index, name='ml_home'),
    ...
    path('schrottoptimierung', views.schrottoptimierung, name='schrottoptimierung'),
    ...
    # path(r'gaugesetting_detail/<str:pk>', views.gaugesetting_detail, name='gaugesetting_detail'),
    path(r'optimierung_detail/<str:pk>', views.optimierung_detail, name='optimierung_detail'),
]
